...
public class OpenApiConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        contact.setEmail("batam1spa@gmail.com");
        contact.setName("Batam1SPA");
        contact.setUrl("https://www.batam1spa.com");
        ...
        Info info = new Info()
                ...
                .version("1.0")
                .contact(contact)
                .description("This API exposes endpoints to manage batam1spa.")
                .termsOfService("https://www.batam1spa.com/terms")
                .license(mitLicense);
